...
/**
 * Represents a table model for displaying a list of ElectricCars objects in a JTable.
 * 
...
public class CarTableModel extends AbstractTableModel {
	...
	/**
	 * List of ElectricCars objects to be displayed in the table.
	 */
	 ...
	 */
	private String[] columnNames = {"ID", "Vrsta", "Proizvodjac", "Model", "Datum nabavke" , "Cijena", "Opis"};
	
	
	/**
	 * Returns the list of electric cars.
	 * @return cars  The list of cars.
	 */
    ...
    /**
     * Constructs a BikeTableModel with the specified list of ElectricCars objects.
     * 
     * @param cars  List of ElectricCars objects to be displayed in the table.
     */
	public CarTableModel(List<ElectricCar> cars) {
		this.cars = cars;
	}

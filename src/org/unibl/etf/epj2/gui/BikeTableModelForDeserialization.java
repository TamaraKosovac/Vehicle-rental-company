...
/**
 * Represents a table model for displaying deserialized list of ElectricBike objects in a JTable.
 * 
 * @author Tamara Kosovac
 */
public class BikeTableModelForDeserialization extends AbstractTableModel{
	private static final long serialVersionUID = 1L;
	
	/**
	 * List of deserialized ElectricBike objects to be displayed in the table.
	 */
	 ...
	 */
	private String[] columnNames = {"ID", "Vrsta", "Proizvodjac", "Model", "Cijena", "Domet", "Cijena popravke"};
	
	
	/**
	 * Returns the list of deserialized electric bikes.
	 * 
	 * @return bikes  The list of deserialized bikes.
	 */
	...
	/**
	 * Sets the list of deserialiazed bikes.
	 * 
	 * @param bikes  The deserialized bikes to set.
	 */
	...
	/**
	 * Constructs a BikeTableModelForDeserialization with the specified list of deserialized ElectricBike objects.
	 * 
	 * @param bikes  List of deserialized ElectricBike objects to be displayed in the table.
	 */
	public BikeTableModelForDeserialization(List<ElectricBike> bikes) {
		this.bikes = bikes;
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 6:
			return String.format("%.1f", bike.getPurchasePrice() * Report.BIKE_COEFFICIENT);
		default:
			return null;
		}
	}
